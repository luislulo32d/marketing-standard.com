						...
						<div class="row initial-row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
									<div class="logo">
										<a href="http://marketing-standard.com/"
								...
								<div id="SkypeButton_Call_marketing_standard_1" style="z-index: 1000;"></div>
										<div style="display: flex; justify-content: space-evenly;">	
											<div class="language-cont">
												<img src="images/frontend/flag-en.jpg" width="16.13" height="12.89" alt="Flag en"/>
												<form name="form1" target="_self">
													<select class="SelectStyle" name="sitio" onChange="javascript:abreSitio()">
														<option class="txt-gray pt-reg f-big">English</option>
														<option class="txt-gray pt-reg f-big" value="marketing-standard.com/inicio.php">Spanish</option>
													</select>
												</form>
											</div>
											<div class="contact-us-cont">
												...
												<p class="ptn-reg f-big-xx txt-white">&nbsp; &nbsp; &nbsp;<span class="pt-bd f-bigger-x">Call us: +34 951.23.93.95</span></p>
											</div>
										</div>
									</div>
								</div>
								...
								<ul class="menu-super" style="margin: 1em;display: flex;justify-content: center;">
										...
										<li class="menu-super-li pt-bd txt-gray f-big-xx">
											<a href="info-request.php">INFO REQUEST</a>
										</li>
										<li class="menu-super-li pt-reg txt-lgray f-big-xx">|</li>
										<li class="menu-super-li pt-bd txt-gray f-big-xx">
											<a href="recommend-us.php">RECOMMEND US</a>
										</li>
										<li class="menu-super-li pt-reg txt-lgray f-big-xx">|</li>
						...
						<div class="top-right-bottom" style="display: none;" id="menu2">
							<ul class="menu-super" style="margin: 1em;display: flex;justify-content: center;">
								<div style="flex-direction: column;">
									...
									<li class="menu-super-li pt-bd txt-gray f-big-xx">
										<a href="recommend-us.php" style="font-size: 14px;">RECOMMEND US</a>
									</li>
								</div>
								<div style="flex-direction: column;">
									
									<li class="menu-super-li pt-bd txt-gray f-big-xx">
										<a href="info-request.php" style="font-size: 14px;">INFO REQUEST</a>
									</li>
									
									<li class="menu-super-li pt-bd txt-gray f-big-xx">
										<a href="contact-us.php" style="font-size: 14px;">CONTACT US</a>
									</li>
								</div>
						...
						<div class="container-fluid">
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav">
									...
									<li class="txt-dgray pt-reg f-big-xx">
										<a href="commitment.php">Commitment</a>
									</li>
									<li class="txt-dgray pt-reg f-big-xx">
										<a href="e-marketing.php">e-Management</a>
									</li>
									<li class="txt-dgray pt-reg f-big-xx">
