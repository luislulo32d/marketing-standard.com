...
<html lang="es">
	<head>
		...
		<title>Marketing Standard - Dossier - Fiesta Sur</title>
		<meta
			name="Description"
						...
						<div class="row">
							...
							<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2">
								<div class="dossier-cont">
									<a href="pdf/dossier-fiesta-sur.pdf" target="_blank">
										<img
											src="images/frontend/dossier-fiesta-sur.png"
											alt="Dossier"
										/>
										<p class="txt-center pt-regi f-big">Dossier Fiesta Sur</p>
									</a>
								</div>
							</div>
