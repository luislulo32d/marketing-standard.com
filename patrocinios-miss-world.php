...
<html lang="es">
	<head>
		...
		<title>Marketing Standard - Patrocinios - Miss World</title>
		<meta
			name="Description"
						...
						<div class="row">
							...
							<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2">
								<div class="dossier-cont">
									<a href="pdf/dossier-miss-world-basico.pdf" target="_blank">
										<img
											src="images/frontend/dossier-miss-world.png"
											alt="Dossier"
										/>
										<p class="txt-center pt-regi f-big">
											Dossier Miss Wold Básico
										</p>
									</a>
								</div>
							</div>
							...
							<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2">
								<div class="dossier-cont">
									<a href="pdf/dossier-miss-world-gold.pdf" target="_blank">
										<img
											src="images/frontend/dossier-miss-world.png"
											alt="Dossier"
										/>
										<p class="txt-center pt-regi f-big">
											Dossier Miss Wold Gold
										</p>
									</a>
								</div>
							</div>
							...
							<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2">
								<div class="dossier-cont">
									<a href="pdf/dossier-miss-world-premium.pdf" target="_blank">
										<img
											src="images/frontend/dossier-miss-world.png"
											alt="Dossier"
										/>
										<p class="txt-center pt-regi f-big">
											Dossier Miss Wold Premium
										</p>
									</a>
								</div>
							</div>
