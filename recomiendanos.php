...
<html lang="es">
	<head>
		...
		<title>Marketing Standard - Recomiendanos</title>
		<meta name="description" content="Recomiendanos con un amigo" />
		<meta name="keywords" content="recomendar, recomiendanos," />
		<meta
			name="subject"
		...
		<link
			rel="canonical"
			href="https://marketing-standard.com/recomiendanos.php"
		/>
		<!-- [LINKS] -->
		<?php
						...
						<div class="inners-cont" style="width: 83%;">
							<form method="post" action="php/recaptchav3.php">
								<div class="request-row">
									<label class="label-forms recomus-label">Tu nombre:</label>
									<input
								...
								<div class="request-row">
									<label class="label-forms recomus-label">Tu e-mail:</label>
									<input
								...
								<input type="hidden" name="form" value="recommend-spanish" />
								<div class="request-row">
									<!-- <div class="submit-form-ru pt-bd txt-white f-big-xx"><a href="form-inactivo.php">ENVIAR</a></div> -->
									<!--<a href="form-inactivo.php">--><input
										type="submit"
										id="submit"
